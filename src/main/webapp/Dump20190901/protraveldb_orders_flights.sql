...
DROP TABLE IF EXISTS `orders_flights`;
...
LOCK TABLES `orders_flights` WRITE;
/*!40000 ALTER TABLE `orders_flights` DISABLE KEYS */;
/*!40000 ALTER TABLE `orders_flights` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-01 21:16:42
